    ...
    <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://firebasestorage.googleapis.com/v0/b/todos-b852b.appspot.com/o/RemoveHanan.png?alt=media&token=6587ffeb-f089-4792-bde6-03be815a73af"
      ...
      >
  <span className="font-bold">Hello, I'm Hanan Khalid.</span> I'm a{" "}
<span className="font-bold">full-stack developer</span> with more than{" "}
<span className="font-bold">a year</span> of hands-on experience. I enjoy
building <span className="italic">sites & apps</span>. My focus is{" "}
<span className="underline"><strong>React (Next.js)</strong></span>.
      ...
      <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
        ...
        <a href="/CV.pdf" download={true} className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack/10 dark:bg-white/10">Download CV{" "} <HiDownload className="opacity-60 group-hover:translate-y-1 transition"/></a>
        <a
